...
{
$DRTypeName="<a href=DR/Receiving><span class=\"badge badge-success\"></span></a>";
$DRType="Dispatch";
$DRTypeRegister="Drivers and Operators";
$Address="AddressTo";
}
else
{
$DRTypeName="<a href=DR/Dispatch><span class=\"badge badge-success\">Drivers and Operators</span></a>";
$DRType="Receiving";
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
				...
				{
					$ButtonContent="Add";
					$AddButton="Add Driver or Machine Operator";
				}
				?>
								...
								<form class="form-horizontal" action="Action" name="ManageDRRegister" id="ManageDRRegister" method="Post">
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
												<label class="form-label span4" for="Reference">Driver Name</label> 
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="D">Date added</label>
									...
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Address">Machinery type</label>
									...
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Remarks">ID Number</label>
													<div class="span8 controls-textarea">
				...
				<div class="row-fluid">	
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>List of Drivers and Operators</span>
									<?php if($count>0) { ?>
							...
							<?php
								...
								$PrintHeading="Drivers and Operators list";
