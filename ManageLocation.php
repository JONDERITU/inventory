...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage other Site Location"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>Delete Site Location "<?php echo $DeleteLocationName; ?>" ??</span>
								</h4>
