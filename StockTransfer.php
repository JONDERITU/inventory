...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Issue item"; BreadCumb($BreadCumb); ?>
				...
				<div class="row-fluid">
					...
					<div class="span8">
                        ...
                        <div class="box chart gradient">
                            <div class="title">
                                <h4>
                                    <span>Issue Report for <?php echo $TransferedStockName ?></span>
                                </h4>
                                <a href="#" class="minimize">Minimize</a>
                            </div>
						...
						<div class="alert alert-error">This is not a valid Item</div>
						<?php } else { ?>
						<div class="alert alert-info">Please select Item Name & Type</div>
						<?php } ?>
					</div>
				</div>
            </div>
