...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb=" Deliveries Register"; BreadCumb($BreadCumb); ?>
				...
				{
					$ButtonContent="Add";
					$AddButton="Add Delivery Details";
				}
				?>
								...
								<form class="form-horizontal" action="Action" name="ManageOCall" id="ManageOCall" method="Post">
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Name">Invoice/Order Number</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="DOC">Request Date</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="CallDuration">Received By</label>
									...
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Mobile">Contacts(Carrier) </label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Landline" readonly>Contacts(Receiver) </label>
									...
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="FollowUpDate">Delivery Date</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Remarks" readonly>Particulars</label>
				...
				<div class="row-fluid">	
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>Are you sure you want to delete delivery order number <?php echo $DeleteCallName; ?> ?</span>
								</h4>
								<br><a href="#" class="minimize tip" title="Minimize">Minimize</a>
							</div>
							<div class="content noPad clearfix">
							<?php if($CallCount>0) { ?>
								<div class="alert alert-error">This entry has some follow ups. Delete them first!!</div>
							<?php } else { ?>
								<form class="form-horizontal" action="ActionDelete" name="DeleteOCall" id="DeleteOCall" method="Post">
									<br><div class="alert alert-error">You require admin password to perform this operation</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									...
									<div class="PrintClass">
										...
										<button class="icomoon-icon-printer-2 tip" title="Print Deliveries List"></button>
										</form>
									</div>
									<?php } ?>
								</h4>
							...
							<?php
								...
								$PrintCallHeading="List of Deliveries";
...
<script type="text/javascript">
	$(document).ready(function() {	
		...
		$("#DeleteOCall").validate({
			...
			messages: {
				Password: {
					required: "You have to enter an admin password to delete this item",
				}
			}   
		});
	});
