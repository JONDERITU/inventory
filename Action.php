...
{	
	...
	{
		$Message="This item is deleted. You cannot update the deleted item!!";
		$Type="error";
	}
	elseif($TOKEN!=$RandomNumber)
	{
...
{	
	...
	if($StudentName=="" || $Mobile=="" || $FatherName=="" || $MotherName=="" || $DOR=="" || $SectionId=="" || $Gender=="")
	{
		$Message="All the fields are mandatory!!";
		$Type="error";
	}
	...
	else
	{
		...
		$query1="insert into registration(StudentsPassword,ParentsPassword,StudentName,FatherName,MotherName,DOR,Gender,SectionId,Mobile,Status,DOE,Session,Username) values
			('$StudentsPassword','$ParentsPassword','$StudentName','$FatherName','$MotherName','$DOR','$Gender','$SectionId','$Mobile','NotAdmitted','$DOE','$CURRENTSESSION','$USERNAME') ";
		mysqli_query($CONNECTION,$query1);
...
{	
	...
	elseif($count>0)
	{
		$Message="This casual is already admitted!!";
		$Type="error";	
	}
	elseif($count2>0)
	{
...
{	
	...
	{	
		...
		$DOB=strtotime($DOB);
		$DOE=strtotime($Date);
		$query1="update registration set StudentName='$StudentName',BloodGroup='$BloodGroup',Caste='$Caste',Category='$Category',DOB='$DOB',DOR='$DOR',FatherName='$FatherName',MotherName='$MotherName',Gender='$Gender' where RegistrationId='$RegistrationId' ";
		mysqli_query($CONNECTION,$query1);
		if($count2==0)
