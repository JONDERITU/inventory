...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="FUEL AND INVENTORY SYSTEM  "; BreadCumb($BreadCumb); ?>
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="box gradient">
									...
									<div class="content clearfix scroll" style="max-height:400px; overflow:auto;">
									<?php
									...
									echo "<div class=\"alert alert-danger\">No Pending Reminder</div>";
									?>									   
									</div>
								</div>
							</div>
						...
						<div class="row-fluid">
							<div class="span12">
								<div class="box gradient">
									<div class="title">
										<h4>
											<span>Fuel Supply/Usage Report</span>
										</h4>
										<a href="#" class="minimize">Minimize</a>
									</div>
									<div class="content clearfix">
									   <div class="lines-chart" style="height: 380px;width:100%;"></div>								
									</div>
								</div>
							</div>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input placeholder="No of Days" tabindex="1" class="span8 tip" title="Number of days you want to show the fuel supply/usage Report" id="REPORTDAYS" type="number" name="REPORTDAYS" value="<?php echo $REPORTDAYS; ?>" />
