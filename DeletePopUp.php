...
elseif($Action=="DeleteExpense")
{
	...
	<div class="alert alert-error">This issuance was not done by you, You cannot delete it. Contact Admin</div>
	<?php } else { ?>
	<div class="alert alert-info">You cannot recover it after deletion. Issued amounts made will be returned to balance</div>
	<?php
...
elseif($Action=="DeleteExpensePayment")
{
	...
	<div class="alert alert-error">This is not a valid Id!!</div>
	<?php } elseif($Username!=$USERNAME && ($USERTYPE!='MasterUser' && $USERTYPE!='Webmaster')) { ?>
	<div class="alert alert-error">This fuel receipt was not done by you. You cannot delete it!</div>
	<?php } else { ?>
	<div class="alert alert-info">You cannot recover it after deletion! Received amount will be deducted from "<b><?php echo "$AccountName";?></b>" !!</div>
	<?php
...
elseif($Action=="DeleteIncome")
{
	...
	<div class="alert alert-error">This is not a valid Id!!</div>
	<?php } elseif($Username!=$USERNAME && ($USERTYPE!='MasterUser' && $USERTYPE!='Webmaster')) { ?>
	<div class="alert alert-error">This amount was not added by you. You cannot delete it!!</div>
	...
	<?php } else { ?>
	<div class="alert alert-info">You cannot recover it after deletion. Amount will be deducted from "<b><?php echo "$AccountName"; ?></b>"!!</div>
	<?php
