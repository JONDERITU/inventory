...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Spare Parts & Oils"; BreadCumb($BreadCumb); ?>
				...
				{
					$ButtonContent="Add";
					$AddButton="Add Spare Parts and Oils	";
				}
				?>
								...
								<form class="form-horizontal" action="Action" name="ManageComplaint" id="ManageComplaint" method="Post">
									<div class="span4">
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
												<label class="form-label span4" for="ComplaintType">Category</label> 
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Name">Spare/oil Name</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="Mobile">Suppliers contact</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="DOC">Date Added</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													...
													Check if spare/oil has been used!!
												</div>
											</div>
										</div>										
										<?php } ?>
				...
				<div class="row-fluid">	
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>Delete this item named "<?php echo $DeleteName; ?>" ??</span>
								</h4>
					...
					while($row=mysqli_fetch_array($result))
					{
						...
						$Tag="<span class=\"date badge badge-success\">Available</span>";
						elseif($ListComplaintStatus=="Resolved")
						$Tag="<span class=\"date badge badge-important\">Used up</span>";
						...
						<div class="box gradient">
							<div class="title">
								<h4>
									...
									<div class="PrintClass">
										...
										<button class="icomoon-icon-printer-2 tip" title="Print "></button>
										</form>
									</div>
									<?php } ?>
								</h4>
							...
							<?php
								$PrintComplaint1="<table id=\"ComplaintTable\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"responsive dynamicTable display table table-bordered\" width=\"100%\">
									<thead>
										<tr>
											<th> Spare/Oil Name</th>
											<th>Supplier contact</th>
											<th>Category</th>
											<th>Date Added</th>
											<th>Description </th>";
											echo $PrintComplaint1;
											echo "<th>Quantity</th><th><span class=\"icon-edit tip\" title=\"Update\"></span></th>
								...
								$PrintComplaintHeading="List of Spares";
...
<script type="text/javascript">
	$(document).ready(function() {	
		...
		$("#DeleteComplaint").validate({
			...
			messages: {
				Password: {
					required: "You are required to enter password to delete this item!!",
				}
			}   
		});
	});
