...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Fuel Usage"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="Expense" id="Expense" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Issued To</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Issued By</label>
												<div class="span8 controls sel">
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Amount Requested</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Date of Request</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Requesting Driver</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Amount Issued</label>
												<input tabindex="6" class="span4 styled" id="Payment" type="checkbox" name="Payment" value="Yes" /> Issued
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Fuel Type</label>
												<div class="span8 controls sel">
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Date of issue</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Vehicle Registration</label>
												<div class="span8 controls-textarea">
					...
					if($Action=="Payment" && $count1>0)
					{
						...
						<div class="box gradient">
							<div class="title">
								<h4><span>Fuel Issue List</span></h4>
                                <a href="#" class="minimize">Minimize</a>
							</div>
						...
						echo "<div class=\"alert alert-error\">All the requested amount was issued</div>";
						?>
							</div>
						</div>
						<?php
					...
					?>
						...
						<div class="box gradient">
							<div class="title">
								<h4><span>Fuel usage List</span></h4>
