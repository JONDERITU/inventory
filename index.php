...
else
{
	...
	else
	{
		...
		{
			$Message="$StudentName is currently not working, You cannot login";
			$Type="error";
		}
		elseif(isset($StaffStatus) && $StaffStatus!="Active" && $Username!='webmaster' && $Username!='masteruser')
		{
			$Message="$Name, We detect that you are currently not working at Toddy. Please contact administrator";
			$Type="error";	
		}
		else
		{
...
?>      
	...
	?>
        <div class="loginContainer">
                ...
                <div class="form-row row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <input tabindex="1" class="span12" id="username" type="text" name="username" placeholder="Username" />
                        </div>
                    </div>
                </div>
                <div class="form-row row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            ...
                            <input tabindex="2" class="span12" id="password" type="password" name="password" placeholder="Password" />
                        </div>
                    </div>
                </div>
                <div class="form-row row-fluid">                       
			...
			<br><span style="font-size:11px; padding:10px;">&copy; Developed by Techcube Limited. 0719369607</span>
        </div>
	<?php
	}
	else
