...
if($ClassButtonContentSet!=1)
{
	...
	$ClassAddButton="Add Casual type";
}
if($SectionButtonContentSet!=1)
{
	$SectionButtonContent="Add";
	$SectionAddButton="Add Grade";
}
...
?>	
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage Casuals Types and Grades"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
                    <div class="span6">
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageClass" id="ManageClass" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="ClassName">Casual Type Name</label>
						...
						<div class="box chart gradient">
							<div class="title">
								<h4>
									<span>Listing All Casual Types</span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
					...
					<div class="span6">
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageSection" id="ManageSection" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="ClassName">Casual Type</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="ClassName">Grade Type Name</label>
						...
						<div class="box chart gradient">
							<div class="title">
								<h4>
									<span>Listing All Casuals and Grades</span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
							<div class="content clearfix noPad">
