...
if($UniqueId!="" && ($Action=="UpdateSubject" || $Action=="DeleteSubject"))
{
	...
	if($count1>0 && $Action=="UpdateSubject")
	{
		...
		$SubjectAddButton="Update <a href=ManageAsset.php><span class=\"cut-icon-plus-2 addbutton\"> Add</span></a>";
...
if($SubjectButtonContentSet!=1)
{
	...
	while($row=mysqli_fetch_array($result))
	{
		...
		$Edit="<a href=ManageAsset/UpdateSubject/$ListSubjectId><span class=\"icon-edit tip\" title=\"Update\"></span></a>";
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage Asset Categories"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageSubject" id="ManageSubject" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="SubjectName">Asset Category</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="SubjectAbb">Added by</label>
												<input tabindex="2" class="span8" id="SubjectAbb" type="textarea" name="SubjectAbb" value="<?php echo $SubjectAbb; ?>" />
											</div>
										</div>
									</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="Class">intended users</label>
					...
					<div class="span8">
						<div class="box chart gradient">
							<div class="title">
								<h4>
									<span>Listing All Office Assets</span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
