...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage store items"; BreadCumb($BreadCumb); ?>
				...
				if($Action=="ListStock" || $Action=="UpdateStock" || $Action=="TransferStock")
				{
					...
					while($row2=mysqli_fetch_array($check2))
					{
						...
						$TransferStock="<a href=ManageStock/TransferStock/$ShowStockType/$ListStockStockId><span class=\"iconic-icon-transfer tip\" title=\"issue out\"></span></a>";
                ...
                <div class="row-fluid">
                    <div class="span4">
                        ...
                        <div class="box chart gradient">
                            <div class="title">
                                <h4>
                                    <span>Issue out <?php echo $TransferStockName; ?></span>
                                </h4>
                            ...
                            <div class="content" style="padding-bottom:5px;">
								...
								<form class="form-horizontal" action="Action" name="TransferStock" id="TransferStock" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Issue To</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Issue Date</label>
								...
								<?php } else { ?>
								<div class="alert alert-error">This stock cannot be issued out because no quantity is available </div>
								<?php } ?>
							</div>
						</div>
						<?php } ?>
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageStock" id="ManageStock" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
											<label class="form-label span4" for="normal">Item Type</label> 
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="normal">Item Name</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
											<label class="form-label span4" for="normal">Unit of Measure</label> 
												<div class="controls sel span8">   
													<?php 
					...
					<div class="span8">
						...
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>List Items of category "<?php echo $ListStockStockTypeName; ?>"</span>
									<?php if($count2>0) { ?>
									<div class="PrintClass">
										...
										<button class="icomoon-icon-printer-2 tip" title="Print Store Item List"></button>
										</form>
									</div>
									<?php } ?>
								</h4>
							...
							<div class="content noPad clearfix">
								...
								$PrintStockHeading=" List of  $ListStockStockTypeName" ;
