...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Insurance and Maintenance"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="box chart gradient">
                            <div class="title">
                                <h4>
                                    <span>Insurance & Service for <?php echo "$Name $AddButton"; ?></span>
                                </h4>
							...
							<div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageFollowUp" id="ManageFollowUp" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="DOF">Next Insurance Date</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="NextFollowUpDate">Next Service Date</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="ResponseDetail" readonly>Condition</label>
					...
					?>
						<div class="box gradient">
							<div class="title">
								<h4>
									<span>Follow Up Record List of <?php echo "$Name"; ?></span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
							<div class="content noPad clearfix">
