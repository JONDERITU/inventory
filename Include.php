...
session_start();
set_time_limit(0);
$APPLICATIONNAME="TODDY CIVIL ENGINEERING LIMITED";
...
$PageKeywords="Toddy Limited";
$PageDescription="Toddy Civil Engineering Inventory System";
$PageAuthor="Samuel Muigai";
$ApplicationName="TODDY Inventory";
...
if(!isset($DatabaseError) && !isset($TableError))
{
	...
	{
		$Message="Please save the company details first before going to any other option!!";
		$Type="error";
	...
	if($USERTYPE!="MasterUser" && $USERTYPE!="Webmaster" && $ByPass!=1)
	{
		...
		if($UserFound<=0)
		{
			$Message="You have no rights to access this page. Contact admin (0725813550)";
			$Type="error";
			SetNotification($Message,$Type);
			header("location:DashBoard");
			exit();
