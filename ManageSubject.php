...
if($SubjectButtonContentSet!=1)
{
	...
	$SubjectAddButton="Add Asset Category";
}
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage Asset Types"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
					...
					<div class="span8">
						<div class="box chart gradient">
							<div class="title">
								<h4>
									<span>Listing All Asset Categories</span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
