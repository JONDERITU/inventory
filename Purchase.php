...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Record Supply"; BreadCumb($BreadCumb); ?>
				...
				<div class="box chart gradient">
					...
					<div class="content" style="padding-bottom:0;">
						<form class="form-horizontal" action="Action" name="Purchase" id="Purchase" method="Post">
							...
							<?php $ButtonContent="Procure"; ActionButton($ButtonContent,6); ?>	
						</form>
					</div>
				</div>
				<?php
				...
				<div class="box chart gradient">
					...
					<div class="alert alert-info"><b>Balance amount : <?php echo "$Balance"; ?></b></div>
						<?php
						if($Balance>0)
						{
						?>
							...
							<div class="form-row row-fluid">
								<div class="span12">
									<div class="row-fluid">
										...
										<input tabindex="21" class="span8" id="AmountPaid" type="text" name="AmountPaid" placeholder="less than <?php echo "$Balance"; ?>" />
									</div>
								</div>
							</div>
							<div class="form-row row-fluid">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="responsive table table-bordered" width="100%">
									...
									<thead>
										<tr>
											...
											<th><?php echo "$FinalPurchasePrice "; ?></th>
