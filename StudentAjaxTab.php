...
?>
	<div class="alert alert-info">You cannot change the worker type once employment is done!!</div>
<form class="form-horizontal" action="Action" name="ManageStudentProfile" id="ManageStudentProfile" method="Post">
	<div class="span4">
		...
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
				<label class="form-label span4" for="StudentSectionId">Category</label> 
		...
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
					<label class="form-label span4" for="UpdateFatherName">Bank Account Number</label>
		...
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
					<label class="form-label span4" for="UpdateMotherName">Bank Name</label>
		...
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
					...
					<input tabindex="25" class="span8" id="UpdateDOR" type="text" name="UpdateDOR" value="<?php echo $UpdateDOR; ?>" readonly/>
				</div>
			</div>
		</div>
		<div class="form-row row-fluid">
		...
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
					...
					<input tabindex="27" class="span8" id="UpdateDOB" type="text" name="UpdateDOB" value="<?php echo $UpdateDOB; ?>" readonly/>
				</div>
			</div>
		</div>
	</div>
	<div class="span4">
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
				<label class="form-label span4" for="UpdateCaste">Physical State</label> 
					<div class="span8 controls sel">  
...
<form class="form-horizontal" action="Action" name="ManageQualification" id="ManageQualification" method="Post">
	<div class="span4">
		<div class="form-row row-fluid">
			<div class="span12">
				<div class="row-fluid">
					<label class="form-label span4" for="normal">University</label>
