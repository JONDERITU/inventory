...
else
{
	...
	$Print.="<table class=responsive>
		<Tr>
		<th>Casuals Name</th><td>$StudentName</td>
		<th>Account Number</th><td>$FatherName</td>
		</tr>
		<Tr>
		<th>Bank Name</th><td>$MotherName</td>
		<th>Mobile</th><td>$Mobile</td>
		</tr>
		<th>Casual Category</th><td>$ClassName</td>
		<th>Grade</th><td>$SectionName</td>
		</tr>";
	$Print.="<table class=responsive><tr>
		<Th>Wage Type</th><th>Amount</th></tr>";
	...
	$Print.="<tr><th>Total Amount Paid</th><th>$SumAmount $CURRENCY</th></table>";
