...
{
	$ButtonContent="Add";
	$AddButton="Add wage Descriptions";
}
...
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                <?php $BreadCumb="Manage Casuals Salary Setup"; BreadCumb($BreadCumb); ?>
                ...
                <div class="row-fluid">
                            ...
                            <div class="content" style="padding-bottom:0;">
								<form class="form-horizontal" action="Action" name="ManageFee" id="ManageFee" method="Post">
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="SectionId">Casual Grade</label>
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="FeeType">Wage Type</label>
												<div class="controls sel span8">   
												<?php
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="FeeType">Hours</label>
												<div class="controls sel span8">   
												<?php
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span4" for="Amount">Amount (KES)</label>
					...
					<div class="span8">
						<div class="box chart gradient">
							<div class="title">
								<h4>
									<span>Listing All Salaries</span>
								</h4>
							<a href="#" class="minimize">Minimize</a>
							</div>
